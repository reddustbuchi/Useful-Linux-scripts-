CONTAINER Mmaterial
{
	...
	GROUP Obaselist
	{
		GROUP
		{
			...
			BOOL MATERIAL_USE_SPECULAR			{ PARENTMSG ID_MATERIALGROUP_SPECULAR; }
			//BOOL MATERIAL_USE_SPECULARCOLOR	{ PARENTMSG ID_MATERIALGROUP_SPECULARCOLOR; }
	...
	GROUP ID_MATERIALGROUP_REFLECTION
	{
		...
		BOOL  MATERIAL_REFLECTION_ADDITIVE { }
		BOOL  MATERIAL_REFLECTION_USE_BUMP { }
		SEPARATOR { }
		SHADERLINK MATERIAL_REFLECTION_SHADER { }
	...
	GROUP ID_MATERIALGROUP_SPECULAR
	{
		...
		//{
			...
			SEPARATOR { }
			SHADERLINK MATERIAL_SPECULAR_SHADER { }
			...
			REAL MATERIAL_SPECULAR_WIDTH { UNIT PERCENT; MIN 0.0; MAX 100.0; CUSTOMGUI REALSLIDER; }
			REAL MATERIAL_SPECULAR_HEIGHT { UNIT PERCENT; MIN 0.0; MAX 1000.0; MAXSLIDER 100.0; CUSTOMGUI REALSLIDER; }
			REAL MATERIAL_SPECULAR_FALLOFF { UNIT PERCENT; MIN -100.0; MAX 100.0; CUSTOMGUI REALSLIDER; }
			REAL MATERIAL_SPECULAR_INNERWIDTH { UNIT PERCENT; MIN 0.0; MAX 100.0; CUSTOMGUI REALSLIDER; }
		//}
	}
	...
	GROUP ID_MATERIALGROUP_DISPLACEMENT
	{
		...
		GROUP ID_MATERIALGROUP_SUBPOLY
		{
			...
			//BOOL MATERIAL_DISPLACEMENT_SUBPOLY_SMOOTH { }
		}
	}
	...
	GROUP ID_MATERIALGROUP_EDITOR
	{
		...
		LONG MATERIAL_EDITORDISPLAY
		{
			CYCLE
			{
				...
				MATERIAL_EDITORDISPLAY_REFLECTION;
		...
		GROUP
		{
			...
			BOOL MATERIAL_DISPLAY_USE_SPECULAR { ANIM OFF; CUSTOMGUI BITMAP_BOOL; }
