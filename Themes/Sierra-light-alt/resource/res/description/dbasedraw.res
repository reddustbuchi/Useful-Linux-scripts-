CONTAINER Dbasedraw
{
	...
	GROUP BASEDRAW_GROUP_STEREO
	{
		...
		{
			COLUMNS 2;
			BOOL BASEDRAW_STEREO_ENABLE { }	
			STATICTEXT {}
			BOOL BASEDRAW_STEREO_USE_RENDERSETTINGS { }
			STATICTEXT {}
			...
			STATICTEXT {}
			BOOL BASEDRAW_STEREO_MULTI_CHANNEL_SWAP { }
			STATICTEXT BASEDRAW_STEREO_STR1 {}
			LONG BASEDRAW_STEREO_MULTI_CHANNEL_PARALLAX { MIN 0; }
...
// 		}
		...
		GROUP BASEDRAW_STEREO_MODE_ANAGLYPH_GROUP
		{
			...
			STATICTEXT { JOINEND; }
			COLOR BASEDRAW_STEREO_MODE_ANAGLYPH_CUSTOM_LEFT { }
			COLOR BASEDRAW_STEREO_MODE_ANAGLYPH_CUSTOM_RIGHT { }
			STATICTEXT { }
		...
		GROUP BASEDRAW_STEREO_MONO_CHANNEL_GROUP
		{
			DEFAULT 1;
			COLUMNS 2;
			LONG BASEDRAW_STEREO_MONO_CHANNEL { }
			STATICTEXT {}
		}
