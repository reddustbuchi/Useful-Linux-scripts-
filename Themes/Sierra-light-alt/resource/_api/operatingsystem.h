...
#include "vector4.h"
#include "matrix4.h"
#include "../res/description/ddoc.h"
...
struct C4D_Shader
{
	...
	Vector					(*GetPointUVW					)(VolumeData *sd, TexData *tdp, const RayHitID &lhit, const Vector64 &p);
	...
	Vector64					(*GetNormal						)(VolumeData *sd, RayObject *op, Int32 polygon, Bool second);
	Vector64					(*GetSmoothedNormal		)(VolumeData *sd, const RayHitID &hit, const Vector64 &p);
	Bool						(*GetRS								)(VolumeData *sd, const RayHitID &hit, const Vector64 &p, Float *r, Float *s);

	void						(*GetRay							)(VolumeData *sd, Float x, Float y, Ray *ray);
	Vector64					(*ScreenToCamera			)(VolumeData *sd, const Vector64 &p);
	Vector64					(*CameraToScreen			)(VolumeData *sd, const Vector64 &p);
	Bool						(*ProjectPoint				)(VolumeData *sd, TexData *tdp, const RayHitID &lhit, const Vector64 &p, const Vector64 &n, Vector *uv);
	...
	void						(*GetWeights					)(VolumeData *sd, const RayHitID &hit, const Vector64 &p, RayPolyWeight *wgt);
	...
	void						(*GetDUDVEx  										)(VolumeData *vd, TexData *tex, const Vector64 &p, const Vector64 &phongn, const Vector64 &orign, const RayHitID &hitid, Bool forceuvw, Vector *ddu, Vector *ddv);
	void						(*CalcArea											)(VolumeData *sd, RayLight *light, Bool nodiffuse, Bool nospecular, Float specular_exponent, const Vector64 &ray_vector, const Vector64 &p, const Vector64 &bumpn, const Vector64 &orign, RAYBIT raybits, Vector *diffuse, Vector *specular);
	Bool						(*Illuminate										)(VolumeData *sd, RayLight *light, Vector *col, Vector64 *lv, const Vector64 &p, const Vector64 &bumpn, const Vector64 &phongn, const Vector64 &orign, const Vector64 &ray_vector, ILLUMINATEFLAGS calc_shadow, const RayHitID &hitid, RAYBIT raybits, Bool cosine_cutoff, Vector *xshadow);
	...
	Vector					(*CalcShadow										)(VolumeData *sd, RayLight *light, const Vector64 &p, const Vector64 &bumpn, const Vector64 &phongn, const Vector64 &orign, const Vector64 &rayv, Bool transparency, const RayHitID &hitid, RAYBIT raybits);
	...
	Bool  					(*TraceGeometryEnhanced				  )(VolumeData *sd, Ray *ray, Float maxdist, const RayHitID &lhit, Int32 raydepth, RAYBIT raybits, Vector64 *oldray, SurfaceIntersection *si);
	...
	RaySampler*			(*GetSampler										)(VolumeData *sd, void *guid, Int32 depth);
	Float						(*GetRayWeight									)(VolumeData *sd);
	...
	Int32						(*GetStreamCount								)(VolumeData *sd);
	void						(*GetStreamRay									)(VolumeData *sd, Int32 stream, Float x, Float y, Ray *ray);

	void						(*GetSceneBoundaries						)(VolumeData *sd, Vector &min, Vector &max);
	Bool						(*GetDisplaceInfo								)(VolumeData *sd, const RayObject* op, DisplaceInfo& info);
	Vector					(*CentralDisplaceUVGetNormal		)(VolumeData *sd, RayObject *op, Int32 local_id, Int32 uu, Int32 vv);
	Int32						(*GetDisplaceNeighbor						)(VolumeData *sd, const RayObject* op, Int32 local_id, Int32 side);
	...
	RayRadianceObject*	(*GetRadianceMaps						)(VolumeData *sd);
	Vector							(*CalcRadianceValue					)(VolumeData *sd, Ray *ray, const SurfaceIntersection &si);
	void						(*GetDUDV  											)(VolumeData *vd, TexData *tex, const Vector64 &p, const Vector64 &phongn, const Vector64 &orign, const RayHitID &hitid, Bool forceuvw, Vector *ddu, Vector *ddv, Bool usetangents);
	Bool						(*IsPhysicalRender							)(VolumeData *sd);
	Int32*					(*GetUniqueID									  )(VolumeData *sd, RayObject *op, Int32 &length);
	...
	void						(*CorrectLocalID								)(VolumeData *sd, const RayObject* op, Int32& local_id);
	Float						(*GetPhysicalCameraIntensity		)(VolumeData *sd);
	Bool						(*CentralDisplacePointUVGetBarycentric)(VolumeData *sd, RayObject *op, Int32& local_id, Int32& uu, Int32& vv, RayPolyWeight& bary, Bool& displaceQuad);
	void						(*SetPhysicalRayTime						)(VolumeData *sd, Float time);
	Vector					(*CalcBackTransformPoint				)(VolumeData *sd);
};
...
struct C4D_String
{
	...
	void						(*InitArray						)(String *str, Int32 count, UInt16 fillchr);
	void						(*Flush								)(String *str);
	void						(*CopyTo							)(const String *src, String *dst);
	Bool						(*Add									)(String *dst,const String *src);

	String					(*RealToString				)(Float v, Int32 vk, Int32 nk, Bool e, UInt16 xchar);
	String					(*LongToString				)(Int32 l);
	String					(*LLongToString				)(Int64 l);
	String					(*LLongToStringExEx		)(Int64 l);

	UInt16					(*GetChr							)(const String *str,Int32 pos);
	void						(*SetChr							)(String *str,Int32 pos,UInt16 chr);
	...
	void						(String::*GetUcBlock		)(UInt16 *Ubc, Int32 Max) const;
	void						(String::*GetUcBlockNull)(UInt16 *Ubc, Int32 Max) const;
	void						(String::*SetUcBlock		)(const UInt16 *Ubc, Int32 Count);
	...
	Bool						(String::*FindFirstCh		)(UInt16 ch, Int32 *Pos, Int32 Start) const;
	Bool						(String::*FindLastCh		)(UInt16 ch, Int32 *Pos, Int32 Start) const;
	...
	String					(*FloatToString32				)(Float32 v, Int32 vvk, Int32 nnk, Bool e, UInt16 xchar);
	String					(*FloatToString64				)(Float64 v, Int32 vvk, Int32 nnk, Bool e, UInt16 xchar);
...
struct C4D_Filename
{
	...
	void						(*SetMemoryReadMode		)(Filename *fn, void *adr, Int size);
...
struct C4D_General
{
	...
	IpConnection*		(*IpWaitForIncomingEx						)(IpConnection* listener, BaseThread* connection, Int32 *ferr);
	void						(*IpCloseConnectionEx						)(IpConnection* ipc);
	void						(*IpKillConnectionEx						)(IpConnection *ipc);
	Int							(*IpBytesInInputBufferEx				)(IpConnection* ipc);
	Int							(*IpReadBytesEx									)(IpConnection* ipc, void* buf, Int size);
	Int							(*IpSendBytesEx									)(IpConnection* ipc, void* buf, Int size);
	void						(*IpGetHostAddrEx								)(IpConnection* ipc, Char *buf, Int32 bufsize);
	void						(*IpGetRemoteAddrEx							)(IpConnection* ipc, Char *buf, Int32 bufsize);

	Bool						(*RecordCommandEx								)(Int32 command_id, Int32 flags, const String &str);
	...
	IpConnection*		(*IpOpenListenerEx							)(UInt32 ipAddr, Int32 port, BaseThread* thread, Int32 timeout, Bool dontwait, Int32* ferr);
	IpConnection*		(*IpOpenOutgoingEx							)(Char* hostname, BaseThread* thread, Int32 initial_timeout, Int32 timeout, Bool dontwait, Int32* ferr);
	...
	Bool						(*RecordCommand									)(Int32 command_id, Int32 flags, const String &str, SCRIPTMODE mode);
	Bool						(*PyRecordCommand								)(Int32 command_id, Int32 flags, const String &str, SCRIPTMODE mode);
...
struct C4D_Network
{
	...
	// IpAddrPort
	Bool								(IpAddrPort::*WriteAP			)(HyperFile *hf) const;
	Bool								(IpAddrPort::*ReadAP			)(HyperFile *hf);
	Bool								(IpAddrPort::*IsValid2		)() const;
	String							(IpAddrPort::*GetStringAP	)(Bool getPort) const;
	void								(IpAddrPort::*SetPort			)(Int t_port);
	...
	IpConnection*				(*IpOpenListener						)(const IpAddrPort& adr, BaseThread* thread, Int timeout, Bool useNagleAlgorithm, Int* error);
	IpConnection*				(*IpOpenListenerString			)(const String& adr, BaseThread* thread, Int timeout, Bool useNagleAlgorithm, Int* error);
	IpConnection*				(*IpOpenOutgoing						)(const IpAddrPort& adr, BaseThread* thread, Int initialTimeout, Int timeout, Bool useNagleAlgorithm, Int* error);
	IpConnection*				(*IpOpenOutgoingString			)(const String& adr, BaseThread* thread, Int initialTimeout, Int timeout, Bool useNagleAlgorithm, Int* error);
	IpConnection*				(*IpWaitForIncoming					)(IpConnection* listener, BaseThread* connection, Int* error);
	void								(*IpCloseConnection					)(IpConnection* ipc);
	void								(*IpKillConnection					)(IpConnection* ipc);

	Int									(*IpBytesInInputBuffer			)(IpConnection* ipc);
	Int									(*IpReadBytes								)(IpConnection* ipc, void* buf, Int size);
	Int									(*IpSendBytes								)(IpConnection* ipc, const void* buf, Int size);
	...
	ZeroConfService*		(*RegisterZeroConfService		)(String serviceName, const String& serviceType, Int lInterface, Int port, const String& domainName, Bool thirdPartyInstance);
	...
	Bool								(*GetIpAddress2							)(const String& address, IpAddr& a, Bool resolve, Bool forceResolve);
	Bool								(*GetIpAddress3							)(const String& address, IpAddrPort& a, Bool resolve, Bool forceResolve);
	...
	String							(*GetHostname2							)(const IpAddr& ipAddr);

	void								(IpAddr::*SDKAlloc					)();
	void								(IpAddr::*SDKAlloc2					)(const IpAddr &adr);
	void								(IpAddr::*SDKFree						)();
	Bool								(IpAddr::*IsEmpty						)() const;
	const GeSockAddrIn* (IpAddr::*GetGeSockAddrIn		)() const;
	void								(IpAddrPort::*SDKAllocPort	)();
	void								(IpAddrPort::*SDKAllocPort2	)(const IpAddr& adr, Int port);
	Bool								(IpAddrPort::*CompareAP			)(const IpAddrPort& adr) const;
};
